...
from esmf_aspect_meta_model_python.pydentic.meta_model_elements.constraints.constraint import Constraint
...
class Trait(BaseModel):
    ...
    :param base_characteristic: The Characterstic that is being constrained.
    :param constraints: A Constraint that is applicable to the base Characteristic. This attribute may be used multiple
        times, to add multiple Constraints to the base Characteristic.
    """
    name: str = ""
